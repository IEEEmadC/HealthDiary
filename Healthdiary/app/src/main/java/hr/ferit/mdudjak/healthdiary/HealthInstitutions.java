...
public class HealthInstitutions extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    Button btnPharmacy, btnHospital;
    @Override
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnPharmacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HealthInstitutions.this,"Nearby Pharmacies", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnHospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(HealthInstitutions.this,"Nearby Hospitals", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(HealthInstitutions.this,"Your Current Location", Toast.LENGTH_LONG).show();
